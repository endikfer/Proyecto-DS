	...
	public class UsuarioService {
	    ...
	    public UsuarioService() {
            ...
            // Crear usuarios
            Usuario user1 = new Usuario("Juan Pérez", "info@google.com", new Date(90, 1, 15), 70.5f, 175, 190, 60);
            Usuario user2 = new Usuario("Ana López", "contact@meta.com", new Date(88, 6, 22), 62.0f, 165, 180, 55);
            Usuario user3 = new Usuario("Carlos Díaz", "support@google.com", new Date(92, 3, 5), 80.0f, 180, 195, 65);
            Usuario user4 = new Usuario("María Gómez", "help@meta.com", new Date(85, 11, 30), 68.0f, 170, 185, 58);
